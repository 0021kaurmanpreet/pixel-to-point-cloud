...
1. Navigate to the [repository](https://github.com/0021kaurmanpreet/pixel-to-point-cloud).
...
1. Update the following files:
   ...
   - `README.md`:
      ...
      ```markdown
      https://0021kaurmanpreet.github.io/pixel-to-point-cloud/
      ```
   ...
   - `landing.py`:
      ...
      ``` bash
      0021kaurmanpreet/pixel-to-point-cloud
      ```
